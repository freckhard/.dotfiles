...
# kdefiles git aliases
alias kg='/usr/bin/git --git-dir=$HOME/.kdefiles --work-tree=$HOME'
alias kgs='kg status'
alias kga='kg add'
alias kgd='kg ydiff -sw0'
alias kgc='kg commit'
alias kgf='kg fetch'
alias kgl='kg log'
alias kgw='kg shortlog -nse'
alias kgit='kg'
alias kgl1='kg log --oneline'
alias kgls='kg log --stat'
alias kglS='kg log --show-signature'
alias kgll='kg log -1 HEAD'
alias kglg='kgl --graph'
alias kgds='kgd --staged'
alias kgL='kg log --oneline --graph --pretty=format:"%C(yellow)%h%Creset %G? %C(blue)%an%Creset %s"'
